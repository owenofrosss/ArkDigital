export default function SoraGuidePage() {
  ...
  return (
    <main style={{ maxWidth: 700, margin: '2rem auto', padding: '2rem', background: '#fff', borderRadius: 8, boxShadow: '0 2px 8px rgba(0,0,0,0.05)' }}>
      ...
      <div style={{ fontFamily: 'inherit', fontSize: '1.1rem', whiteSpace: 'pre-wrap', wordBreak: 'break-word' }}>
        📎 <strong>Free Resource Vault</strong><br />
        Everything you need to turn free AI images into real money
        <br /><br />
        <strong>🔥 Top Sora Prompts (Tested for Merch)</strong><br />
        ...
        Upload your AI image<br />
        Adjust placement → click Save → Done<br />
        You can connect to Etsy or just download mockups and sell directly.<br /><br />
        <strong>💼 Fiverr Gig Templates (Copy & Paste)</strong><br />
        <u>Gig Title Ideas:</u>
        <ul>
